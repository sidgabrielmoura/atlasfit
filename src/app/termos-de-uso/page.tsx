...
import { ShieldCheck, FileText, Calendar, Hash, ArrowLeft } from "lucide-react";

export const dynamic = "force-dynamic";

export default async function TermsOfUsePage() {
  const doc = await LegalAcceptanceService.getActiveDocument(LegalDocumentType.TERMS);
      ...
      <div className="max-w-4xl mx-auto space-y-8">
            ...
            <div className="flex flex-wrap items-center justify-between gap-2">
              <div className="space-y-1">
                <CardTitle className="text-2xl sm:text-3xl font-extrabold tracking-tight">
                  {doc?.title || "Termos de Uso do AtlasFit"}
                </CardTitle>
                <CardDescription className="text-base">
                  Condições contratuais para utilização da plataforma por profissionais e assessorias.
                </CardDescription>
              </div>
        ...
        <div className="text-center text-xs text-muted-foreground space-y-2">
          ...
          <div className="flex justify-center space-x-4">
            <Link href="/politica-de-privacidade" className="hover:underline text-primary">
