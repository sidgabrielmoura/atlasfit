                ...
                <CardContent className="pt-4 space-y-4 text-xs">
                  <div className="space-y-1.5">
                    ...
                    >
                      ...
                      <SelectContent>
                        <SelectItem value="gemini-3-flash-preview" className="text-xs">Gemini 3 Flash (Recomendado)</SelectItem>
                        <SelectItem value="gemini-3-pro-preview" className="text-xs">Gemini 3 Pro (Raciocínio Avançado)</SelectItem>
                      </SelectContent>
                    </Select>
                  </div>
