            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-4 bg-secondary/5 border border-border/40 p-4 rounded-2xl">
                ...
                <div className="space-y-3">
                  ...
                  {formData.segmentation.roles[0] !== "PERSONAL" && (
                    <div className="space-y-1.5">
                      <Label className="text-[10px] font-bold text-muted-foreground">Objetivo do Aluno</Label>
                      <Select
        ...
        {selectedStatsExp && (
          <DialogContent className="max-w-xl rounded-2xl! p-6!">
            ...
            <div className="space-y-4 pt-4">
              <div className="space-y-1">
                <Label className="text-[10px] font-black uppercase tracking-widest text-muted-foreground">Conversão e Engajamento</Label>
                <p className="text-[9px] text-muted-foreground font-semibold uppercase">Dados qualitativos adicionais registrados pelo motor.</p>
              </div>

              <div className="bg-secondary/5 border border-border/40 p-4 rounded-2xl flex flex-col gap-3">
                <div className="flex justify-between items-center text-xs font-semibold">
                  <span className="text-muted-foreground">Participações em Desafios:</span>
                  <span className="text-foreground font-bold">{selectedStatsExp.stats?.joins || 0}</span>
                </div>
                <div className="flex justify-between items-center text-xs font-semibold">
                  <span className="text-muted-foreground">Conclusões Registradas:</span>
        ...
        <AlertDialogContent className="rounded-2xl border-border/40">
          <AlertDialogHeader>
            ...
            <AlertDialogDescription className="text-xs font-semibold text-muted-foreground">
              Esta ação não poderá ser desfeita. A campanha <strong className="text-foreground">"{expToDelete?.title}"</strong> será permanentemente excluída e todos os logs de engajamento dos alunos serão removidos.
