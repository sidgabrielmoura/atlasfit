...
export async function PATCH(
  ...
  try {
    ...
    const existingExperience = await prisma.engageExperience.findFirst({
    ...
    await logSystemError({ action: "PATCH_PERSONAL_ENGAGE", error, entity: "ENGAGE_EXPERIENCE" });
...
export async function DELETE(
  ...
  try {
    ...
    await logSystemError({ action: "DELETE_PERSONAL_ENGAGE", error, entity: "ENGAGE_EXPERIENCE" });
    return new NextResponse("Internal Error", { status: 500 });
  }
}
