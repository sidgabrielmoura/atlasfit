...
export async function GET(req: Request) {
  ...
  try {
    ...
    // Aggregate statistics in one database roundtrip
    ...
    await logSystemError({ action: "GET_PERSONAL_ENGAGE", error, entity: "ENGAGE_EXPERIENCE" });
...
export async function POST(req: Request) {
  ...
  try {
    ...
    await logSystemError({ action: "POST_PERSONAL_ENGAGE_CREATE", error, entity: "ENGAGE_EXPERIENCE" });
    return new NextResponse("Internal Error", { status: 500 });
  }
}
