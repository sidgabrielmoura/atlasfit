  ...
  return (
    <div className="flex-1 space-y-6 p-4 md:p-8 pt-6 max-w-4xl mx-auto">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h2 className="text-2xl sm:text-3xl font-bold tracking-tight">Criar Modelo de Treino</h2>
          <p className="text-sm text-muted-foreground mt-0.5">Monte um novo modelo de treino estruturado para seus alunos.</p>
        </div>
      </div>
                          ...
                          {muscleGroups.map((group) => {
                            ...
                            return (
                              <Button
                                ...
                                className={cn(
                                  "h-8 px-3 rounded-full flex-1 text-xs font-medium transition-all shrink-0",
                                  isActive
                        ...
                        <div className="flex flex-wrap gap-1.5 max-h-20 overflow-y-auto">
                          {tempSelected.map((ex) => (
                            <Badge
                              key={ex.id}
                              variant="secondary"
                              className="gap-1 flex-1 min-w-fit px-2.5 py-1 text-xs font-medium bg-secondary text-foreground rounded-full border border-border"
                            >
                              {ex.name}
                              <button
                                type="button"
      ...
      <Dialog open={methodDialogOpen} onOpenChange={setMethodDialogOpen}>
        <DialogContent className="max-w-md w-[95%] rounded-xl">
          ...
          <div className="space-y-4 pt-4">
            ...
            <div className="flex flex-col-reverse sm:flex-row justify-end gap-2 pt-4 border-t border-border mt-4 w-full">
              <Button
                type="button"
                variant="outline"
