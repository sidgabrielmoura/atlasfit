  ...
  if (loading) {
    return (
      <div className="flex flex-col items-center justify-center py-40 gap-3">
        ...
        <p className="text-sm text-muted-foreground">Carregando dados do treino...</p>
      </div>
    );
  }
  ...
  return (
    <div className="flex-1 space-y-6 p-4 md:p-8 pt-6 max-w-4xl mx-auto">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h2 className="text-3xl font-bold tracking-tight">Editar Modelo de Treino</h2>
          <p className="text-muted-foreground mt-0.5">Modifique os dados e estrutura do treino criado.</p>
        </div>
      </div>
